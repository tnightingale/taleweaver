...
export default function StandalonePlayer() {
  ...
  return (
    <>
      {isOffline && (
        <div className="fixed bottom-[7.5rem] sm:bottom-auto sm:top-2 left-2 z-30 px-3 py-1.5 rounded-full
      ...
      {cachedOffline && !isOffline && (
        <motion.div
          ...
          className="fixed bottom-[7.5rem] sm:bottom-auto sm:top-2 left-2 z-30 px-3 py-1.5 rounded-full
